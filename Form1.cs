...
namespace Presidents
{
    public partial class Form1 : Form
    {
        ...
        {
            string wikiUrl = "https://en.wikipedia.org/wiki/Ronald_Reagen";
            webBrowser1.Navigate(wikiUrl);
        ...
        {
            string wikiUrl = "https://en.wikipedia.org/wiki/John_Adams";
            webBrowser1.Navigate(wikiUrl);
        ...
        {
            string wikiUrl = "https://en.wikipedia.org/wiki/Theodore_Roosevelt";
            webBrowser1.Navigate(wikiUrl);
